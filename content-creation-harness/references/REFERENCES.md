...
- **brand-voice.md** — Writing tone, style, and intended audience. Read by `creation/write/`, `creation/produce/`, and `polish/proofread/`. Fill this in before using the creation or polish skills.
